...
EventHub.logic.on(GAME_EVENT.EXISTENCE_RESET_AFTER, () => Autobuyers.reset());
...
EventHub.logic.on(GAME_EVENT.EXISTENCE_RESET_AFTER, () => Autobuyers.resetTick(PRESTIGE_EVENT.EXISTENCE));
